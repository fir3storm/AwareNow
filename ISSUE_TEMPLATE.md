...
Before filing a new issue, please use the search bar at the top of the browser to search for similar issues. Also, please make sure you have read our [documentation](README.md), which covers how to use AwareNow.

What version of AwareNow are you using?:
