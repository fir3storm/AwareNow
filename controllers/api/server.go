...
func (as *Server) registerRoutes() {
	...
	router.HandleFunc("/assessments/{id:[0-9]+}/phases", mid.Use(as.AssessmentPhaseHandler, mid.RequirePermission(models.PermissionModifyObjects)))
	router.HandleFunc("/assessments/{id:[0-9]+}/evidence", mid.Use(as.AssessmentEvidence, mid.RequirePermission(models.PermissionModifyObjects))).Methods("GET")
