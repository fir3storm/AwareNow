...
// AdminServer is an HTTP server that implements the administrative AwareNow
...
// and management of user accounts within AwareNow.
...
// required either by the AwareNow system or an administrator.
//
